...
public abstract class Step {
    ...
    protected int nacimientosTotales = 0;
    protected int muertesTotales = 0;
    protected int supervivenciasTotales = 0;
    ...
    public int getNacimientosTotales() {
        return nacimientosTotales;
    }

    public int getMuertesTotales() {
        return muertesTotales;
    }

    public int getSupervivenciasTotales() {
        return supervivenciasTotales;
    }

    public void incrementarNacimientos(){
        this.nacimientosTotales++;
    }
    ...
    public void incrementarSupervivencias(){
        this.supervivenciasTotales++;
    }
